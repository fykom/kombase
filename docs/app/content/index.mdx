...
Ensure you have installed and configured [shadcn/ui](https://ui.shadcn.com/docs/installation) in your project. `kombase` relies on the shadcn component architecture for UI consistency.
